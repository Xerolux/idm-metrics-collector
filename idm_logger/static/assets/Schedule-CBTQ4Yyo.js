import{B as _,a as h,o,g as O,h as y,p as v,m as r,s as T,f as u,t as S,V as le,k as M,n as P,z as D,C as ke,W as Ie,A as Se,M as J,X as W,Z as we,Y as xe,$ as Ce,a0 as Ve,a1 as Le,a2 as Fe,D as E,a3 as Me,a4 as Pe,J as Te,a5 as B,l as fe,b,F as K,j as H,x as Q,w as x,T as $e,H as Ke,a6 as Ae,q as X,r as z,v as De,K as Ee,y as N,d as w}from"./index-DLjl5ne7.js";import{s as de}from"./index-BO4KLqya.js";import{a as me,f as R,c as Be,R as ze,s as Y}from"./index-CHH6fVDS.js";import{s as Re}from"./index-CRGJvjI5.js";import{s as He}from"./index-DzPnhBE-.js";import{s as re,a as ge}from"./index-DtfRWzU2.js";import{a as Ne,s as Ue,b as je,x as se}from"./index-CE8M_kOK.js";import{a as Ge,b as qe,c as Ze,d as Je,e as We,C as Ye,O as Xe}from"./index-hHCs669T.js";import{s as Qe}from"./index-Dv-EoTRR.js";import{a as _e,s as et}from"./index-DIdVWG3r.js";var tt=`
    .p-tag {
        display: inline-flex;
        align-items: center;
...
`,mt={root:"p-chip p-component",image:"p-chip-image",icon:"p-chip-icon",label:"p-chip-label",removeIcon:"p-chip-remove-icon"},gt=_.extend({name:"chip",style:ft,classes:mt}),bt={name:"BaseChip",extends:me,props:{label:{type:[String,Number],default:null},icon:{type:String,default:null},image:{type:String,default:null},removable:{type:Boolean,default:!1},removeIcon:{type:String,default:void 0}},style:gt,provide:function(){return{$pcChip:this,$parentInstance:this}}},ye={name:"Chip",extends:bt,inheritAttrs:!1,emits:["remove"],data:function(){return{visible:!0}},methods:{onKeydown:function(e){(e.key==="Enter"||e.key==="Backspace")&&this.close(e)},close:function(e){this.visible=!1,this.$emit("remove",e)}},computed:{dataP:function(){return R({removable:this.removable})}},components:{TimesCircleIcon:_e}},yt=["aria-label","data-p"],vt=["src"];function Ot(t,e,i,n,s,l){return s.visible?(o(),h("div",r({key:0,class:t.cx("root"),"aria-label":t.label},t.ptmi("root"),{"data-p":l.dataP}),[v(t.$slots,"default",{},function(){return[t.image?(o(),h("img",r({key:0,src:t.image},t.ptm("image"),{class:t.cx("image")}),null,16,vt)):t.$slots.icon?(o(),O(T(t.$slots.icon),r({key:1,class:t.cx("icon")},t.ptm("icon")),null,16,["class"])):t.icon?(o(),h("span",r({key:2,class:[t.cx("icon"),t.icon]},t.ptm("icon")),null,16)):y("",!0),t.label!==null?(o(),h("div",r({key:3,class:t.cx("label")},t.ptm("label")),S(t.label),17)):y("",!0)]}),t.removable?v(t.$slots,"removeicon",{key:0,removeCallback:l.close,keydownCallback:l.onKeydown},function(){return[(o(),O(T(t.removeIcon?"span":"TimesCircleIcon"),r({class:[t.cx("removeIcon"),t.removeIcon],onClick:l.close,onKeydown:l.onKeydown},t.ptm("removeIcon")),null,16,["class","onClick","onKeydown"]))]}):y("",!0)],16,yt)):y("",!0)}ye.render=Ot;var kt=`
    .p-multiselect {
        display: inline-flex;
        cursor: pointer;
        position: relative;
