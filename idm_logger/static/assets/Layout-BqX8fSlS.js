import{z as le,a as f,o as l,f as h,m as d,B as ce,A as L,C as B,M as U,Y as de,D as S,E as x,J as be,G as Y,k as F,l as J,F as O,x as fe,h as v,g as C,q as Q,n as P,s as K,t as N,H as he,p as E,b as I,I as pe,K as Ie,_ as ve,r as k,L as X,N as $,O as ee,w as _,T as ge,u as ye,P as ke,c as D,e as we,d as y}from"./index-Cs0ddHiM.js";import{x as V}from"./index-s5A8uwEI.js";import{b as te,R as xe,a as ne,s as R}from"./index-CEH4iTFC.js";import{s as Le}from"./index-DWsTO5Bo.js";import{s as Pe}from"./index-_YLJJJpw.js";import{_ as Ce}from"./AppFooter-Kd9Ukj4F.js";import"./index-D2w-Fv8R.js";const q="dashboard_edit_mode",Me=le("ui",{state:()=>({editMode:!1,initialized:!1}),actions:{init(){if(!this.initialized){if(typeof window<"u"){const t=window.localStorage.getItem(q);this.editMode=t==="true"}this.initialized=!0}},setEditMode(t){this.editMode=t,typeof window<"u"&&window.localStorage.setItem(q,`${t}`)},toggleEditMode(){this.setEditMode(!this.editMode)}}});var ie={name:"BarsIcon",extends:te};function Ae(t){return Oe(t)||Ee(t)||Ke(t)||Se()}function Se(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
