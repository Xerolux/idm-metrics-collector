...
class MQTTPublisher:
    ...
    def publish_data(self, data):
        ...
        try:
            # Compute timestamp once for the entire batch to avoid redundant system calls and ensure consistency
            ...
            for sensor_name, value in data.items():
                ...
                payload = {"value": value, "unit": unit, "timestamp": current_time}
