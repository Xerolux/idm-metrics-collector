...
class MetricsWriter:
    ...
    def _send_data(self, data: Union[Dict, List[Dict]]) -> bool:
        ...
        tags = self._get_tags()
        # Bolt optimization: pre-calculate string prefix to avoid redundant allocations in loop
        ...
        for measurements in items:
            ...
            for key, value in measurements.items():
                if key.endswith("_str"):
                    continue
                # Bolt optimization: use elif and inline ternary to avoid double type check and cast overhead
