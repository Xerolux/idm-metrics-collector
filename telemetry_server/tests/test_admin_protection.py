...
def test_protected_admin_permissions_cannot_be_revoked(mock_env_vars, protected_admin_id):
    ...
    assert pm.permission_manager.has_permission(protected_admin_id, "admin:full") is True
