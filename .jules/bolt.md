...
## 2026-08-13 - Redundant syscalls in loops
**Learning:** System calls like `time.time()` inside loops where the result does not change across iterations introduce unnecessary overhead.
**Action:** Hoist invariant system calls outside of loops to minimize redundant executions.
