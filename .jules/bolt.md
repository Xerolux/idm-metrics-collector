...
## 2024-05-24 - Line Protocol Optimization
**Learning:** Pre-calculating string prefixes and using inline conditionals for boolean conversions inside hot loops avoids redundant allocations.
**Action:** Pre-calculate common strings outside of loops and avoid function calls for booleans on hot paths.
