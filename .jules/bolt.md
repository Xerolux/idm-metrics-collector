...
## 2026-04-09 - Temporary files in PR
**Learning:** Creating scratchpad or performance benchmark scripts (like test_perf.py) is helpful for local validation, but leaving them in the repository pollutes the root directory and triggers code review feedback.
**Action:** When creating temporary scratchpad or benchmark files in the workspace, always delete them before requesting code review or submitting changes.
