  ...
  <div class="p-4 flex flex-col gap-4">
    ...
    <div v-else class="flex flex-col gap-6">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <Card
          class="bg-gray-800 text-white border-dashed border-2 border-gray-600 flex justify-center items-center cursor-pointer hover:bg-gray-700 transition-colors focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:outline-none"
          @click="showAddDialog = true"
          @keydown.enter.self="showAddDialog = true"
          @keydown.space.prevent.self="showAddDialog = true"
          role="button"
          tabindex="0"
