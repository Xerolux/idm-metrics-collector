  ...
  <div class="bg-white rounded-lg p-3 shadow-sm border border-gray-200 overflow-y-auto">
    <div class="flex items-center justify-between mb-3">
      ...
      <button
        ...
        class="p-1 hover:bg-gray-100 rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
        :disabled="loading"
      ...
      <div class="flex flex-wrap gap-1">
        ...
        >
          ...
          <button
            ...
            class="hover:text-teal-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 rounded p-0.5"
            :title="'Sensor entfernen: ' + sensor.display"
            :aria-label="'Sensor entfernen: ' + sensor.display"
          >
