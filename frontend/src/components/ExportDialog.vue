      ...
      <div>
        ...
        <div class="grid grid-cols-2 gap-3">
          <button
            ...
            :class="[
              'p-3 rounded-lg border-2 text-center transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500',
              exportType === 'visual'
      ...
      <div>
        ...
        <div v-if="exportType === 'visual'" class="grid grid-cols-2 gap-3">
          <button
            ...
            :class="[
              'p-4 rounded-lg border-2 text-center transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500',
              selectedFormat === 'png'
                ? 'border-blue-500 bg-blue-50 text-blue-700'
                : 'border-gray-200 hover:border-gray-300'
            ]"
