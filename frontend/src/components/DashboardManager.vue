    ...
    <div v-if="!isLoadingDashboards" class="flex-grow min-h-0 flex flex-col lg:flex-row gap-3 lg:overflow-hidden">
      ...
      <div class="flex-grow overflow-y-auto pb-4 pr-1 relative" @dragover.prevent @drop="onDrop">
        ...
        <div
          ...
          class="mt-3 h-32 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center hover:border-teal-500 hover:bg-teal-50 cursor-pointer transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-teal-500"
          @click="showAddChartDialog = true"
