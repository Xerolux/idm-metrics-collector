    ...
    <div class="flex-grow min-h-0 flex flex-col lg:flex-row gap-3 lg:overflow-hidden">
      ...
      <div class="flex-grow overflow-y-auto pb-4 pr-1 relative" @dragover.prevent @drop="onDrop">
        ...
        <button
          v-if="editMode"
          type="button"
          class="w-full mt-3 h-32 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center hover:border-teal-500 hover:bg-teal-50 cursor-pointer transition-colors focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2"
          @click="showAddChartDialog = true"
