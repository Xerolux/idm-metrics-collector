...
<template>
  ...
  <div class="fixed bottom-4 right-4 z-40">
    <div
      :class="[
        'w-3 h-3 rounded-full border-2 border-gray-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-gray-700',
        isOnline ? 'bg-success-500' : isBrowserOnline ? 'bg-warning-500' : 'bg-error-500'
      ]"
      :title="getStatusText()"
      role="status"
      :aria-label="'Verbindungsstatus: ' + getStatusText()"
      tabindex="0"
    ></div>
  </div>
</template>
