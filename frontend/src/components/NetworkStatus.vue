...
<template>
  ...
  <div class="fixed bottom-4 right-4 z-40">
    <div
      :class="[
        'w-3 h-3 rounded-full border-2 border-gray-700 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900 focus-visible:outline-none cursor-help',
